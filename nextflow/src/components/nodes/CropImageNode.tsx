    ...
    <BaseNode id={id} type="crop-image" label={d.label || "Crop Image"} accentColor="#ef4444" icon={<Crop className="w-3.5 h-3.5" />} isRunning={d.isRunning} runStatus={d.runStatus} runError={d.runError} selected={selected}>
      ...
      {outputIsImage && (
        <div className="space-y-1.5 mt-2">
          ...
          <img src={outputImageUrl} alt="cropped" style={{ width: "100%", maxHeight: 140, objectFit: "cover", borderRadius: 8, border: "1px solid #1e1e2a", background: "#0a0a0f", cursor: "pointer" }} onClick={() => setShowModal(true)} onMouseDown={e => e.stopPropagation()} />
