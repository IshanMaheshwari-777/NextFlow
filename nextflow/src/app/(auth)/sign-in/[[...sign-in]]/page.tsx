    ...
    <div style={{
      ...
      <nav style={{
        ...
        <div style={{ fontSize: 14, color: "rgba(255,255,255,0.7)", fontWeight: 500 }}>
          Don't have an account? <Link href="/sign-up" style={{ color: "#fff", textDecoration: "none", fontWeight: 600 }}>Sign up</Link>
        </div>
      </nav>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingBottom: 64, position: "relative", zIndex: 10 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <h1 style={{ fontSize: 32, fontWeight: 600, color: "#fff", margin: "0 0 12px", letterSpacing: "-0.02em" }}>Welcome back</h1>
          <p style={{ fontSize: 15, color: "rgba(255,255,255,0.7)", margin: 0, fontWeight: 400 }}>Log in to your NextFlow workspace</p>
        </div>
