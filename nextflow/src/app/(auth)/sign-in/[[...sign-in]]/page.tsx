    ...
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", background: "var(--bg)", position: "relative", fontFamily: "sans-serif" }}>
      ...
      <nav style={{ 
        ...
        <div style={{ fontSize: 13, color: "var(--text-muted)", fontWeight: 500 }}>
          Don't have an account? <Link href="/sign-up" style={{ color: "var(--text)", textDecoration: "none" }}>Sign up</Link>
        </div>
      </nav>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", paddingBottom: 64, position: "relative", zIndex: 10 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          <h1 style={{ fontSize: 24, fontWeight: 600, color: "var(--text)", margin: "0 0 8px" }}>Welcome back</h1>
          <p style={{ fontSize: 14, color: "var(--text-secondary)", margin: 0, fontWeight: 500 }}>Log in to your NextFlow workspace</p>
        </div>
