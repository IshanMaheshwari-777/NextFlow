  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "center", position: "relative", zIndex: 10, marginBottom: 32, display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        <h1 style={{ fontSize: 24, fontWeight: 700, color: "var(--text)", letterSpacing: "-0.03em", margin: 0 }}>Create your account</h1>
        <p style={{ fontSize: 14, color: "var(--text-muted)", marginTop: 8, fontWeight: 500 }}>Start building AI workflows</p>
      </div>
